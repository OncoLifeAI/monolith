...
import { useUpdatePatient } from '@patient-portal/api-client';
...
const EditPatientModal: React.FC<EditPatientModalProps> = ({ open, patient, onClose }) => {
  ...
  useEffect(() => {
    if (patient) {
      setFormData({
        ...
        associateClinic: patient.associateClinic || '',
