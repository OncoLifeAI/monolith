...
import { MessageCircle, LibraryBig, Notebook, Grid3X3, LogOut, ChevronRight, ChevronLeft, LayoutDashboard, Users } from 'lucide-react';
import logo from '../../assets/logo.png';
import { useNavigate } from 'react-router-dom';
import { SESSION_START_KEY } from '../SessionTimeoutManager';
import { useUser } from '@patient-portal/auth-lib';
import { useUserType } from '@patient-portal/auth-lib';
